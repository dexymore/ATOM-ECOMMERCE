...
const UserProfile: React.FC = () => {
  ...
  const downloadInvoice = async (order: any) => {
    ...
    const buttonElement = document.querySelector(
      `#invoice-${order._id} #download-button`
    );
  ...
  return (
    <>
      {loading ? (
        ...
        <div className="flex flex-col mt-20 mb-5 items-center max-w-full mx-auto">
          <ul className="flex flex-col items-center min-h-screen space-y-4">
            <li className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm w-[85%]">
              <div className="b-w-full bg-white border border-gray-200 p-6 rounded-lg shadow hover:bg-gray-100">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
                  welcome{" "}
                  <span className="text-green-500 atom">{user?.name}</span>{" "}
                  happy shopping
                </h5>
            ...
            {userOrders.length > 0 ? (
              userOrders.map((order: any) => (
                <li
                  ...
                  className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm w-[85%]"
                >
              ...
              <li className="rounded-lg border border-gray-200  bg-white p-4 shadow-sm w-[85%] text-center">
