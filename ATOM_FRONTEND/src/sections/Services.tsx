...
const Services: React.FC<Props> = () => {
 ...
 <div className="w-full self-end flex flex-col text-black px-32 py-20">
        <div className="self-end w-1/2 mb-4">
          <h2 className="text-5xl font-bold">
            we have sold over <span className="text-orange-500">+20000</span>{" "}
            order for more than 3 years
          </h2>
        </div>
...
<div className="w-full flex flex-col text-white px-32 py-20 bg-slate-950">
  ...
  <div className="p-5">
    ...
    <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">we are commited to produce the elegant collection of all the time</p>
