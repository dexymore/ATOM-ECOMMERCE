...
const NavBar: React.FC = () => {
  ...
  return (
    <>
      <motion.nav
        className={`border-gray-200 w-full fixed ${navBackground}`}
        initial={{ y: 0 }}
        ...
        style={{
            zIndex: 4, // Ensure the overlay is above the background image
          }}
      >
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            className={MobileNavBar ? "items-center justify-between w-full :flex md:w-auto md:order-1" : "hidden"}
            id="navbar-user"
          >
